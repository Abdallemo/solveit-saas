  ...
  return (
    <div className="relative">
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        ...
        />
        <motion.div
          className="absolute top-3/4 right-1/4 w-24 h-24 bg-linear-to-br from-primary/5 via-background to-accent/10 rounded-full blur-xl"
          variants={{
            animate: {
              y: [-10, 10, -10],
              transition: {
        ...
        />
        <motion.div
          className="absolute top-1/2 right-1/3 w-16 h-16 bg-linear-to-br from-primary/5 via-background to-accent/10 rounded-full blur-lg"
          variants={{
            animate: {
              y: [-10, 10, -10],
              transition: {
        ...
        <motion.div
          className="absolute w-96 h-96 bg-linear-to-br from-primary/5 via-background to-accent/10 rounded-full blur-3xl"
          animate={{
      ...
      >
        <motion.div className="space-y-4" variants={itemVariants}>
          ...
          >
            ...
            <motion.span
              className="relative inline-block bg-linear-to-br from-primary via-indigo-500 to-purple-600 bg-clip-text text-transparent bg-[length:200%_200%]"
              animate={{
            ...
            >
              Solveit
              <motion.div
                className="absolute inset-0 bg-linear-to-br from-primary/20 via-indigo-500/20 to-purple-600/20 blur-2xl -z-10"
                animate={{
                  opacity: [0.2, 0.4, 0.2],
                  scale: [0.8, 1.1, 0.8],
                }}
