...
export function VideoCallPageComps({
  ...
  return (
    <div className="flex flex-col w-full h-full justify-between items-center bg-background">
      <div className="w-full flex items-center justify-center gap-3 px-6 py-3 border-b border-border bg-background/95 backdrop-blur-sm">
        <DropdownMenu>
        ...
        {isScreenSharing && (
          <div
            className={cn(
              ...
              expandedVideo === "localScreen" ? "col-span-full row-span-2" : "",
          ...
          <div
            className={cn(
              ...
              expandedVideo === "remoteScreen"
                ...
                : "",
              expandedVideo && expandedVideo !== "remoteScreen" ? "hidden" : ""
            )}>
            <video
              ref={remoteScreenShare}
              autoPlay
      ...
      <div className="flex justify-center items-center gap-3 py-4 px-6 w-full border-t border-border bg-background/95 backdrop-blur-sm">
        <Button
