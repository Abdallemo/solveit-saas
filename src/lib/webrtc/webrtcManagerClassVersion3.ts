// SignalingService.ts (Kept from your original context)
...
abstract class WebRTCPeerWorker {
...
class CameraPeerWorker extends WebRTCPeerWorker {
...
class ScreenPeerWorker extends WebRTCPeerWorker {
...
class WebRTCManager implements SignalHandler {
  ...
  private cameraWorker: CameraPeerWorker;
  private screenWorker: ScreenPeerWorker;
  ...
  constructor({ userId, sessionId }: ManagerOptions) {
    ...
    this.cameraWorker = new CameraPeerWorker(
      userId,
      sessionId,
      this.signaling,
      () => this.notify(),
    ...
    this.screenWorker = new ScreenPeerWorker(
      userId,
      sessionId,
      this.signaling,
      () => this.notify(),
