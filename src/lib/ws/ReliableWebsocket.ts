// reliable-websocket.ts
export type ConnectionState = "connecting" | "connected" | "disconnected";

export interface ReliableWebSocketOptions<MsgType extends object> {
...
export class ReliableWebSocket<MsgType extends object> {
  ...
  constructor(
    private url: string,
    private options: ReliableWebSocketOptions<MsgType>
  ) {
