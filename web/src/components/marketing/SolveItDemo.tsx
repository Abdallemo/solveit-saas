...
import { CodeEditorDialog } from "../editors/MonocaWraper";
...
export default function SolveItDemo() {
  ...
  const [activeFile, setActiveFile] = useState<(typeof mockFiles)[0] | null>(
    null
  );
            ...
            <div className="p-4 border-b">
              ...
              <div
                ...
                <p className="text-xs text-gray-500 dark:text-gray-500 mt-1">
                  PDF, DOC, JPG up to 200MB • 0/5 files
                </p>
              </div>
              <input
                ref={fileInputRef}
      ...
      <div className="bg-amber-50 border-b border-amber-200 px-4 py-2">
        <div className="flex items-center justify-center gap-2 text-amber-800">
          ...
          <span className="text-sm font-medium">
            ⚠️ Sandbox Preview — Changes will not be saved
          </span>
        </div>
      </div>
